<div class="modal fade" id="modalupload" tabindex="-1">
    <div class="modal-dialog modal-sm modal-dialog-centered">
        ...
        <div class="modal-content">
            ...
            <br>
            <center>
                <img class="img-thumbnail" id="img_load" src="<?= base_url('/public/img/konfigurasi/pimpinan/'  . $list['gbr_sambutan']) ?>" alt="Foto">
            </center>
            <input type="hidden" value="<?= $id_setaplikasi ?>" name="id_setaplikasi">
            <div class="modal-body">
                <div class="form-group">
                    <label>Ganti Foto</label>
                    <input type="file" class="form-control" id="gbr_sambutan" name="gbr_sambutan">
                    <div class="invalid-feedback errorgbr_sambutan"></div>
                </div>
...
<script>
    $('.btnupload').click(function(e) {
        ...
        $.ajax({
            type: "post",
            url: '<?= base_url('sambutan/douploadlogo') ?>',
            data: data,
            ...
            success: function(response) {
                if (response.error) {
                    if (response.error.gbr_sambutan) {
