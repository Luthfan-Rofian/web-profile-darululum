                    ...
                    <div class="tab-pane" id="lainlain" role="tabpanel">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 col-12">
                                ...
                                <input type="text" id="asal_s1" name="asal_s1" class="form-control">
                            ...
                            <div class="form-group col-md-6 col-12">
                                ...
                                <input type="text" id="asal_s2" name="asal_s2" class=" form-control">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 col-12">
                                ...
                                <input type="text" id="asal_s3" name="asal_s3" class="form-control">
                            ...
                            <div class="form-group col-md-6 col-12">
                                ...
                                <input type="text" id="bidang_pakar" name="bidang_pakar" class=" form-control">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control form-control-sm" id="bio_singkat" name="bio_singkat"></textarea>
                        </div>
                    </div>
