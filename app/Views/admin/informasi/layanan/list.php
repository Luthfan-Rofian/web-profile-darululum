...
<div class="table-responsive b-0 ">
    <table id="listlayanan" class="table table-hover table-striped">
            ...
            foreach ($list as $data) :
                ...
                <tr>
                    ...
                    <td class="text-center p-0">
                        ...
                        <?php } else { ?>
                            <img class="img-circle elevation-2 pointer" title="Ganti Gambar" onclick="gantifoto('<?= $data['informasi_id'] ?>')" src="<?= base_url('public/img/informasi/layanan/' . $data['gambar']) ?>" height="100%" width="55px">
                        <?php } ?>
                    </td>
                    <td class="text-center p-0">
