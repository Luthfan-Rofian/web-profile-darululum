...
<head>
    ...
    <meta content="Control Web Panel CMS LEMBAGA" name="Control Web Panel CMS LEMBAGA" />

    <link rel="shortcut icon" href="<?= base_url('/public/img/konfigurasi/icon/' . $konfigurasi->icon) ?>">
    <link rel="stylesheet" href="<?= base_url() ?>/public/template/temp-backend/plugins/morris/morris.css">

    <link href="<?= base_url() ?>/public/template/temp-backend/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css">
    <link href="<?= base_url() ?>/public/template/temp-backend/assets/css/metismenu.min.css" rel="stylesheet" type="text/css">
    <link href="<?= base_url() ?>/public/template/temp-backend/assets/css/icons.css" rel="stylesheet" type="text/css">
    <link href="<?= base_url() ?>/public/template/temp-backend/assets/css/style.css" rel="stylesheet" type="text/css">
    <link href="<?= base_url() ?>/public/template/temp-backend/plugins/bootstrap-touchspin/css/jquery.bootstrap-touchspin.min.css" rel="stylesheet" />
    <!-- DataTables -->
    ...
    <link href="<?= base_url() ?>/public/template/temp-backend/plugins/summernote/summernote-bs4.css" rel="stylesheet" />
    <!-- Toast -->
    <link href="<?= base_url() ?>/public/template/temp-backend/assets/css/toastr.min.css" rel="stylesheet" type="text/css">
    <link href="<?= base_url() ?>/public/template/temp-backend/plugins/select2/css/select2.min.css" rel="stylesheet" type="text/css" />
    <!-- jQuery  -->

    <script src="<?= base_url() ?>/public/template/temp-backend/assets/js/jquery.min.js"></script>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="topbar p-0">
            <!-- LOGO -->
            <div class="topbar-left text-white p-0" style="background-color:#006316">
                <a href="<?= base_url('dashboard') ?>" class="logo">
                    <span>
                        <img src="<?= base_url('/public/template/temp-backend/assets/images/cwpv11.png') ?>" alt="" height="50">
                    </span>
                    <i>
            ...
            <nav class="navbar-custom p-0" style="background-color:#006316">
...
<!-- jQuery  -->
<script src="<?= base_url() ?>/public/template/temp-backend/assets/js/bootstrap.bundle.min.js"></script>
<script src="<?= base_url() ?>/public/template/temp-backend/assets/js/metisMenu.min.js"></script>
<script src="<?= base_url() ?>/public/template/temp-backend/assets/js/jquery.slimscroll.js"></script>

<!-- Required datatable js -->
<script src="<?= base_url() ?>/public/template/temp-backend/plugins/datatables/jquery.dataTables.min.js"></script>
<script src="<?= base_url() ?>/public/template/temp-backend/plugins/datatables/dataTables.bootstrap4.min.js"></script>

<!-- Buttons examples -->
<script src="<?= base_url() ?>/public/template/temp-backend/plugins/datatables/dataTables.buttons.min.js"></script>
<script src="<?= base_url() ?>/public/template/temp-backend/plugins/datatables/buttons.bootstrap4.min.js"></script>
<script src="<?= base_url() ?>/public/template/temp-backend/plugins/datatables/jszip.min.js"></script>
<script src="<?= base_url() ?>/public/template/temp-backend/plugins/datatables/pdfmake.min.js"></script>
<script src="<?= base_url() ?>/public/template/temp-backend/plugins/datatables/vfs_fonts.js"></script>
<script src="<?= base_url() ?>/public/template/temp-backend/plugins/datatables/buttons.html5.min.js"></script>
<script src="<?= base_url() ?>/public/template/temp-backend/plugins/datatables/buttons.print.min.js"></script>
<script src="<?= base_url() ?>/public/template/temp-backend/plugins/datatables/buttons.colVis.min.js"></script>

<!--Summernote js-->
<script src="<?= base_url() ?>/public/template/temp-backend/plugins/summernote/summernote-bs4.min.js"></script>

<!-- Responsive examples -->
<script src="<?= base_url() ?>/public/template/temp-backend/plugins/datatables/dataTables.responsive.min.js"></script>
<script src="<?= base_url() ?>/public/template/temp-backend/plugins/datatables/responsive.bootstrap4.min.js"></script>

<!-- Datatable init js -->
<script src="<?= base_url() ?>/public/template/temp-backend/assets/pages/datatables.init.js"></script>

<!-- App js -->
<script src="<?= base_url() ?>/public/template/temp-backend/assets/js/app.js"></script>

<script src="<?= base_url() ?>/public/template/temp-backend/plugins/jquery-sparkline/jquery.sparkline.min.js"></script>

<!-- toast -->
<script src="<?= base_url() ?>/public/template/temp-backend/assets/js/toastr.min.js"></script>
<script src="<?= base_url() ?>/public/template/temp-backend/plugins/select2/js/select2.min.js"></script>

<script src="<?= base_url() ?>/public/template/temp-backend/plugins/bootstrap-maxlength/bootstrap-maxlength.min.js"></script>
<!-- <script src="<?= base_url() ?>/public/template/temp-backend/assets/pages/form-advanced.js"></script> -->
<script src="<?= base_url() ?>/public/template/temp-backend/plugins/bootstrap-touchspin/js/jquery.bootstrap-touchspin.min.js"></script>
<script src="<?= base_url() ?>/public/template/temp-backend/assets/js/jquery.slimscroll.js"></script>

<script src="<?= base_url() ?>/public/template/temp-backend/plugins/bootstrap-touchspin/js/jquery.bootstrap-touchspin.min.js"></script>
<script src="<?= base_url() ?>/public/template/temp-backend/plugins/chart.js/chart.min.js"></script>
<!-- <script src="<?= base_url() ?>/public/template/temp-backend/assets/js/jquery.min.js"></script> -->
