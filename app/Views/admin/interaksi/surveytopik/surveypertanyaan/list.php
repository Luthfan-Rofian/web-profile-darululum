            ...
            foreach ($list as $data) :
                ...
                <tr>
                    ...
                    <td class="text-center p-0">
                        <a href="<?= base_url('survey/jawaban/' . $data['pertanyaan_id']) ?>" title="Manajemen Jawaban" class="btn btn-primary btn-sm p-1">
                            <i class="fas fa-list text-light"></i></a>
                        <button type="button" title="Edit Data" class="btn btn-warning btn-sm p-1" onclick="edit('<?= $data['pertanyaan_id'] ?>','<?= $data['survey_id'] ?>')">
                            <i class="fa fa-edit"></i>
                        </button>
                        <button type="button" title="Hapus Data" class="btn btn-danger btn-sm p-1" onclick="hapus('<?= $data['pertanyaan_id'] ?>','<?= $data['pertanyaan'] ?>')">
