...
<div class="table-responsive b-0 ">
    <table id="listbidang" class="table table-hover table-striped">
        <thead class="">
            <tr>
        ...
        <tbody>
            ...
            foreach ($list as $data) :
                ...
                <tr>
                    ...
                    <td><?= esc($data['nama_bidang']) ?></td>

                    <td class="text-center p-0">
                        <?php if ($akses == 1) { ?>
                            <button type="button" class="btn btn-warning btn-sm p-1" onclick="edit('<?= $data['bidang_id'] ?>')">
                                <i class="icon fas fa-edit text-light"></i>
                            </button>

                            <button type="button" class="btn btn-danger btn-sm p-1" onclick="hapus('<?= $data['bidang_id'] ?>')">
