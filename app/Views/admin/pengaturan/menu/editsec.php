                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12">
                        ...
                        <div class="form-control">
                            ...
                            <input type="radio" name="posisi" id="posisi1" value="1" <?= $posisi == '1' ? 'checked' : '' ?>> <label for="posisi1" class="pointer">Top Menu &nbsp</label>
                            <input type="radio" name="posisi" id="posisi2" value="2" <?= $posisi == '2' ? 'checked' : '' ?>> <label for="posisi2" class="pointer"> Footer Menu &nbsp</label>
