            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12">
                        ...
                        <input type="text" id="nama_subsubmenu" name="nama_subsubmenu" class="form-control form-control-sm">
                ...
                <div class="form-group" id="eksternal">
                    <label>
                        Link URL <small class="text-danger">(Misalnya: http://aplikasipendidikan.net/)</small>
                    </label>
                    <input type="text" id="link_subsubmenu" name="link_subsubmenu" class="form-control form-control-sm">
                    <div class="invalid-feedback errorlink_subsubmenu"></div>
                </div>
                <input type="hidden" id="linkexternalssm" name="linkexternalssm" class="form-control form-control-sm">


                <div class="row">
                    <div class="form-group col-md-6 col-12">
                        <label>Urutan Menu</label>
                        <input type="number" class="form-control form-control-sm" id="urutanssm" name="urutanssm">
                    ...
                    <div class="form-group col-md-6 col-12">
                        ...
                        <div class="form-control form-control-sm">
                            ...
                            <input type="radio" id="targetsm1" name="targetssm" value="_parent" checked><label for="targetsm1" class="pointer">&nbsp_parent &nbsp</label>
                            <input type="radio" id="targetsm2" name="targetssm" value="_blank"><label for="targetsm2" class="pointer">&nbsp_blank &nbsp</label>
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12">
                        ...
                        <input type="text" class="form-control form-control-sm" id="iconssm" name="iconssm">
                    </div>
