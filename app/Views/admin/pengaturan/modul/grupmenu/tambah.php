        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12">
                        <label> <i class="mdi mdi-text-shadow"></i>
                            Ambil Grup <small>Jika grup sama dgn di list</small>
                        </label>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-12">
                        ...
                        <input type="text" id="gm" name="gm" class="form-control form-control-sm">
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12">
                        ...
                        <div class="invalid-feedback errorikonmn"></div>
...
<script>
    $(document).ready(function() {
        ...
        $('.btnsimpan').click(function(e) {
            ...
            $.ajax({
                type: "post",
                url: '<?= site_url('modul/simpangrupmenu') ?>',
                data: data,
