...
<div class="table-responsive b-0 ">
    <table id="listmodul" class="table table-hover table-striped">
        <thead class="">
            <tr>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="p-1">&nbsp; &nbsp;<i class="<?= $data['ikonmn'] ?>"></i> <?= esc($data['modul']) ?></td>
                    ...
                    <td class="text-center p-1">
                        <?php if ($akses == 1) { ?>
                            ...
                            <button type="button" class="btn btn-warning btn-sm p-1" onclick="edit('<?= $data['id_modul'] ?>')">
                                <i class="icon fas fa-edit text-light"></i>
                            </button>

                            <?php if ($data['level'] == 3) { ?>
                                <button type="button" class="btn btn-danger btn-sm p-1" onclick="hapus('<?= $data['id_modul'] ?>','<?= $data['modul'] ?>')">
                                    <i class="far fa-trash-alt text-light"></i>
                                </button>
                                <button type="button" class="btn btn-info btn-sm p-1" title="Kelola Hak Aksesss" onclick="setakses('<?= $data['id_modul'] ?>')">
