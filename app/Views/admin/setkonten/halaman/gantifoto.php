        ...
        <div class="modal-content">
            ...
            <center>
                ...
                <?php if ($gambar != 'default.png') { ?>
                    <img class="img-thumbnail" id="img_load" src="<?= base_url('public/img/informasi/profil/'  . $gambar) ?>" alt="Sampul Profil">
                <?php } else { ?>
                    <img class="img-thumbnail" id="img_load" src="<?= base_url('public/img/informasi/profil/default.png') ?>" alt="Sampul Profil">
                <?php } ?>
            </center>
...
<script>
    $(document).ready(function() {
        $('.btnupload').click(function(e) {
            ...
            $.ajax({
                type: "post",
                url: '<?= site_url('halaman/douploadBerita') ?>',
                data: data,
