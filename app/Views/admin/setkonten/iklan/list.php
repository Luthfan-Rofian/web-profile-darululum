...
<div class="table-responsive b-0 ">
    <table id="listiklan" class="table table-hover table-striped">
            ...
            ?>
                <tr>
                    ...
                    <td class="text-center p-0">
                        <?php if ($akses == 1) { ?>
                            <button type="button" class="btn btn-warning btn-sm p-1" onclick="edit('<?= $value['id_banner'] ?>')">
                                <i class="fa fa-edit"></i>
                            </button>
                            <button type="button" class="btn btn-danger btn-sm p-1" onclick="hapus('<?= $value['id_banner'] ?>','<?= $value['ket'] ?>')">
