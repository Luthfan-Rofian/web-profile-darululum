        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" id="faq_tanyaid" name="faq_tanyaid" value="<?= $faq_tanyaid ?>" class="form-control">
                    <textarea type="text" class="form-control" id="faq_jawaban" name="faq_jawaban"></textarea>
...
<script>
    $(document).ready(function() {
        ...
        $('.btnsimpan').click(function(e) {
            ...
            $.ajax({
                type: "post",
                url: '<?= site_url('tanyajawab/simpanjawaban') ?>',
                data: data,
