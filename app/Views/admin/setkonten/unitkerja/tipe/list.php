...
<div class="table-responsive b-0 ">
    <table id="listtipe" class="table table-hover table-striped">
        <thead class="">
            <tr>
            ...
            foreach ($list as $data) :
                ...
                <tr>
                    ...
                    <td class="text-center p-0">
                        <?php if ($akses == 1) { ?>
                            <button type="button" class="btn btn-info btn-sm" onclick="edit('<?= $data['tipe_id'] ?>')">
                                <i class="icon fas fa-edit text-light"></i>
                            </button>

                            <button type="button" class="btn btn-danger btn-sm" onclick="hapus('<?= $data['tipe_id'] ?>')">
