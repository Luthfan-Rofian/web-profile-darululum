...
<div class="table-responsive b-0 ">
    <table id="listinfografis" class="table table-hover table-striped">
        ...
        <tbody>
            ...
            foreach ($list as $value) :
                ...
                <tr>
                    ...
                    <td class="p-1"><img class="img-circle elevation-2" src="<?= base_url('public/img/informasi/infografis/' .  $value['banner_image']) ?>" width="80px" height="80px"></td>
                    <td><?= $value['ket'] ?></td>
